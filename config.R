EXPERIMENT = "prior_module_LAMA" # label for your run, pick something short but descriptive without spaces and valid as part of a filename
PREFIX = "_condor" # prefix for per-job .err, log, .lst, and .out files
JOBS = c(1:45)
HOST_REGEXP = "^limpopo[^8]" # a regular expression to select execute hosts from the cluster
...
SEED_JOB_RELEASES = 3 # number of times to auto-release held seed jobs before giving up
